...
SWIFT_CLASS("_TtC15BanubaSdkSimple21EffectPlayerTouchView")
@interface EffectPlayerTouchView : UIView
...
SWIFT_CLASS("_TtC15BanubaSdkSimple16EffectPlayerView")
@interface EffectPlayerView : EffectPlayerTouchView
